...
<master:ContentPage>
    ...
    <master:Content contentPlaceHolderId="body">
            ...
            <div class="layui-card-header">
                <div class="layui-form-item">
                    <div class="layui-input-inline">
                        <input type="text" name="title" required  lay-verify="required" placeholder="输入关键字搜索……" class="layui-input">
                        <i class="layui-icon layui-icon-refresh-3 my-refresh" style="cursor: pointer"></i>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript" src="/model/core/iconfont/res/index.js"></script>
    </master:Content>
</master:ContentPage>
