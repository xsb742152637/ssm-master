...
(function (global, factory) {
    ...
    Html2Canvas.init = factory();


    /**
     *
     * @param doc 需要截取的document对象
     * @param fileName 文件名称，不含后缀
     */
    Html2Canvas.saveFile = function(doc,fileName){
        if(fileName == undefined || fileName == null){
            ...
            //年月日加上随机数
            fileName = fullYear + '' + month + date + randoms.slice(3,10);

        }
        Html2Canvas.init(doc).then(function(canvas) {
            //保存图片
            var sf = function(data, filename){
